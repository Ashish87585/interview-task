...
exports.getUserByName = exports.getAllUser = exports.logoutUser = exports.signinUser = exports.signupUser = void 0;
...
var signupUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, password, phone, existingUser, hashedPassword, user, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                user = new User_1.default({ name: name, email: email, password: hashedPassword, phone: phone });
...
var logoutUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, res.cookie("jwt", null, {
...
var getUserByName = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var regex, user, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                regex = new RegExp(req.params.name, 'i');
                return [4 /*yield*/, User_1.default.find({ name: regex })];
            case 1:
                user = _a.sent();
                res.json({ user: user });
                return [3 /*break*/, 3];
